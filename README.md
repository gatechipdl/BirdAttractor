...
## Requirements
 ...
 Microcontroller Interrupts for wakeup from deep sleep. ESP8266 can do this on 
 Two daily alarms for on and off settings. Interrupt based.
 ...
 Real Time Clock with a tempreature compensated crystal oscillator (TCXO).
